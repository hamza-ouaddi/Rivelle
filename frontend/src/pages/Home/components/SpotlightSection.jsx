  ...
  return (
    <section className="font-clashDisplay text-white flex flex-col lg:flex-row gap-4  mx-4 md:mx-10 lg:mx-16 mt-36">
      ...
      >
        ...
        <h1 className="font-medium text-[64px] md:text-8xl w-3/4 xl:w-1/2 leading-none">
          TAKE IT IF YOU LIKE IT
        </h1>
        <p className="font-normal text-[32px]">www.rivelle.com</p>
      </div>
      <div className="flex flex-col gap-4 w-full lg:w-[55%]">
        ...
        >
          ...
          <h2 className="font-normal text-4xl md:text-5xl text-center w-full xl:w-2/3 z-10">
        ...
        >
          <h1 className="font-medium text-[64px] md:text-6xl xl:text-8xl w-full sm:w-4/6 lg:w-[96%] 2xl:w-4/5 leading-none">
            Indulge in exclusive deals
          </h1>
          <p className="font-normal text-[32px] leading-none">
